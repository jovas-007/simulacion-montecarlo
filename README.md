...
- **Resultados:** el programa guarda un histograma en formato SVG y un reporte
  en texto plano con las métricas principales de la simulación.
...
- `histograma_utilidad.svg`: gráfica de la distribución de utilidades.
